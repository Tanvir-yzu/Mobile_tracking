...
SECRET_KEY = "django-insecure-oco3qhx69u1fa$*#t_1ri*y*8my72gafx=3m&4_dgiklajz)c6"
...
STORAGES = {
    ...
    "dbbackup": {
        "BACKEND": "django.core.files.storage.FileSystemStorage",
        "OPTIONS": {
            "location": os.path.join(BASE_DIR, 'my/backup'),  # Windows FIX: absolute path + backslashes
        },
    },
}
